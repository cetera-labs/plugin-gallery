<?php
function editor_matset_gallery_draw($field_def, $fieldvalue, $id = false, $idcat = false, $math = false, $user = false) {
    $type = $field_def['len'];
...
?>
                    Ext.create('Plugin.gallery.Field',{
                        name: '<?=$field_def['name']?>',
...
function editor_matset_gallery_init($field_def, $fieldvalue, $id = false, $idcat = false, $math = false, $user = false) {
    $type = $field_def['len'];
    $od = new Cetera\ObjectDefinition($type);
